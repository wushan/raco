/*! jQuery tinyMap v3.3.15, Licensed MIT (c) essoduke.org | http://app.essoduke.org/tinyMap/ */
window.gMapsCallback=function(){$(window).trigger('gMapsCallback')};
(function(g,u,p,G){function q(a,b){var c={lat:'',lng:''},d=[],e=/^[+-]?\d+(\.\d+)?$/;if('string'===typeof a||Array.isArray(a))if(d=Array.isArray(a)?a:a.toString().replace(/\s+/,'').split(','),2===d.length)e.test(d[0])&&e.test(d[1])&&(c.lat=d[0],c.lng=d[1]);else return a;else if('object'===typeof a){if('function'===typeof a.lat)return a;a.hasOwnProperty('x')&&a.hasOwnProperty('y')?(c.lat=a.x,c.lng=a.y):a.hasOwnProperty('lat')&&a.hasOwnProperty('lng')&&(c.lat=a.lat,c.lng=a.lng)}return!0===b?new google.maps.LatLng(c.lat,
c.lng):c}function x(a){var b=a.hasOwnProperty('css')?a.css.toString():'';this.setValues(a);this.span=g('<span/>').css({position:'relative',left:'-50%',top:'0','white-space':'nowrap'}).addClass(b);this.div=g('<div/>').css({position:'absolute',display:'none'});this.span.appendTo(this.div)}function z(a,b){var c=this,d=g.extend({},F,b);c.map=null;c._markers=[];c._markersCluster=[];c._clusters={};c._bounds={};c._labels=[];c._polylines=[];c._polygons=[];c._circles=[];c._kmls=[];c._directions=[];c._directionsMarkers=
...
F={autoLocation:!1,center:[24,121],infoWindowAutoClose:!0,interval:200,loading:'\u8b80\u53d6\u4e2d&hellip;',notFound:'\u627e\u4e0d\u5230\u67e5\u8a62\u7684\u5730\u9ede',zoom:8},A={},A={greyscale:[{featureType:'all',stylers:[{saturation:-100},{gamma:.5}]}]};z.prototype={VERSION:'3.3.15',formatSize:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Size(a[0],a[1]):a},formatPoint:function(a){return Array.isArray(a)&&2===a.length?new google.maps.Point(a[0],a[1]):a},overlay:function(){var a=
this.map,b=this.options;try{this.kml(a,b),this.directionService(a,b),this.placeMarkers(a,b),this.drawPolyline(a,b),this.drawPolygon(a,b),this.drawCircle(a,b),this.streetView(a,b),this.places(a,b),this.geoLocation(a,b)}catch(c){console.error(c)}},bindEvents:function(a,b){var c=this,d={};switch(typeof b){case 'function':google.maps.event.clearListeners(a,'click');google.maps.event.addListener(a,'click',b);break;case 'object':for(d in b)'function'===typeof b[d]?'created'===d?b[d].call(a):(google.maps.event.clearListeners(a,
d),google.maps.event.addListener(a,d,b[d])):b[d].hasOwnProperty('func')&&'function'===typeof b[d].func?b[d].hasOwnProperty('once')&&!0===b[d].once?google.maps.event.addListenerOnce(a,d,b[d].func):(google.maps.event.clearListeners(a,d),google.maps.event.addListener(a,d,b[d].func)):'function'===typeof b[d]&&(google.maps.event.clearListeners(a,d),google.maps.event.addListener(a,d,b[d]))}a.hasOwnProperty('infoWindow')&&(google.maps.event.clearListeners(a,'click'),google.maps.event.addListener(a,'click',
function(){var b=0,d={};if(c.options.hasOwnProperty('infoWindowAutoClose')&&!0===c.options.infoWindowAutoClose)for(b=0;b<c._markers.length;b+=1)d=c._markers[b],d.hasOwnProperty('infoWindow')&&'function'===typeof d.infoWindow.close&&d.infoWindow.close();a.infoWindow.open(c.map,a)}))},kml:function(a,b){var c={url:'',map:a,preserveViewport:!1,suppressInfoWindows:!1},d={},e=0;if(b.hasOwnProperty('kml'))if('string'===typeof b.kml)c.url=b.kml,d=new google.maps.KmlLayer(c),this._kmls.push(d);else if(Array.isArray(b.kml))for(e=
0;e<b.kml.length;e+=1)'string'===typeof b.kml[e]?(c.url=b.kml[e],d=new google.maps.KmlLayer(c)):'object'===typeof b.kml[e]&&(c=g.extend({},c,b.kml[e]),d=new google.maps.KmlLayer(c),c.hasOwnProperty('event')&&this.bindEvents(d,c.event)),this._kmls.push(d)},drawPolyline:function(a,b){var c={},d=[],e={},f={},h={},h={},k=[],r=[],n=0,h={},h={},m=0,v=function(a,b){if(b===google.maps.DirectionsStatus.OK){for(m=0;m<a.routes[0].overview_path.length;m+=1)r.push(a.routes[0].overview_path[m]);e.setPath(r);'function'===
typeof c.getDistance&&(f=a.routes[0].legs[0].distance,c.getDistance.call(this,f))}};if(b.hasOwnProperty('polyline')&&Array.isArray(b.polyline))for(n=0;n<b.polyline.length;n+=1)if(c=b.polyline[n],c.hasOwnProperty('coords')&&Array.isArray(c.coords)){k=new google.maps.MVCArray;for(m=0;m<c.coords.length;m+=1)h=c.coords[m],h=q(h,!0),'function'===typeof h.lat&&k.push(h);h=g.extend({},{strokeColor:c.color||'#FF0000',strokeOpacity:c.opacity||1,strokeWeight:c.width||2},c);e=new google.maps.Polyline(h);this._polylines.push(e);
if(2<k.getLength())for(m=0;m<k.length;m+=1)0<m&&k.length-1>m&&d.push({location:k.getAt(m),stopover:!1});c.hasOwnProperty('event')&&this.bindEvents(e,c.event);c.hasOwnProperty('snap')&&!0===c.snap?(h=new google.maps.DirectionsService,h.route({origin:k.getAt(0),waypoints:d,destination:k.getAt(k.length-1),travelMode:google.maps.DirectionsTravelMode.DRIVING},v)):(e.setPath(k),google.maps.hasOwnProperty('geometry')&&google.maps.geometry.hasOwnProperty('spherical')&&'function'===typeof google.maps.geometry.spherical.computeDistanceBetween&&
(f=google.maps.geometry.spherical.computeDistanceBetween(k.getAt(0),k.getAt(k.length-1)),'function'===typeof c.getDistance&&c.getDistance.call(this,f)));e.setMap(a)}},drawPolygon:function(a,b){var c={},d={},c=[],e=0,d=0,f={},f={};if(b.hasOwnProperty('polygon')&&Array.isArray(b.polygon))for(e=0;e<b.polygon.length;e+=1)if(c=[],b.polygon[e].hasOwnProperty('coords')){for(d=0;d<b.polygon[e].coords.length;d+=1)f=b.polygon[e].coords[d],f=q(f,!0),'function'===typeof f.lat&&c.push(f);d=g.extend({},{path:c,
strokeColor:b.polygon[e].color||'#FF0000',strokeOpacity:1,strokeWeight:b.polygon[e].width||2,fillColor:b.polygon[e].fillcolor||'#CC0000',fillOpacity:.35},b.polygon[e]);c=new google.maps.Polygon(d);this._polygons.push(c);c.setMap(a);d.hasOwnProperty('event')&&this.bindEvents(c,d.event)}},drawCircle:function(a,b){var c={},d={},c={},e={},f=0;if(b.hasOwnProperty('circle')&&Array.isArray(b.circle))for(f=0;f<b.circle.length;f+=1)d=b.circle[f],c=g.extend({map:a,strokeColor:d.color||'#FF0000',strokeOpacity:d.opacity||
.8,strokeWeight:d.width||2,fillColor:d.fillcolor||'#FF0000',fillOpacity:d.fillopacity||.35,radius:d.radius||10,zIndex:100,id:d.hasOwnProperty('id')?d.id:''},d),d.hasOwnProperty('center')&&(e=q(d.center,!0),c.center=e),'function'===typeof e.lat&&(c=new google.maps.Circle(c),this._circles.push(c),d.hasOwnProperty('event')&&this.bindEvents(c,d.event))},markerIcon:function(a){var b={};if(a.hasOwnProperty('icon')){b=a.icon;if('string'===typeof a.icon)return a.icon;a.icon.hasOwnProperty('url')&&(b.url=
a.icon.url);a.icon.hasOwnProperty('size')&&Array.isArray(a.icon.size)&&2===a.icon.size.length&&(b.size=this.formatSize(a.icon.size));a.icon.hasOwnProperty('scaledSize')&&Array.isArray(a.icon.scaledSize)&&2===a.icon.scaledSize.length&&(b.scaledSize=this.formatSize(a.icon.scaledSize));a.icon.hasOwnProperty('anchor')&&Array.isArray(a.icon.anchor)&&2===a.icon.anchor.length&&(b.anchor=this.formatPoint(a.icon.anchor))}return b},processMarker:function(a,b,c,d){var e=this,f=e.get('marker'),h={},k={};c.hasOwnProperty('position')&&
('function'===typeof c.getPosition&&e._bounds.extend(c.position),b.hasOwnProperty('markerFitBounds')&&!0===b.markerFitBounds&&f.marker.length===b.marker.length&&a.fitBounds(e._bounds));c.hasOwnProperty('text')&&c.text.length&&(c.hasOwnProperty('infoWindow')&&'function'===typeof c.infoWindow.setContent?c.infoWindow.setContent(c.text):(c.infoWindow=new google.maps.InfoWindow(c.hasOwnProperty('infoWindowOptions')?c.infoWindowOptions:{content:c.text}),c.hasOwnProperty('infoWindowOptions')&&'undefined'!==
typeof c.infoWindowOptions.event&&e.bindEvents(c.infoWindow,c.infoWindowOptions.event)));d||(!c.hasOwnProperty('cluster')||c.hasOwnProperty('cluster')&&!0===c.cluster)&&'function'===typeof e._clusters.addMarker&&e._clusters.addMarker(c);c.hasOwnProperty('newLabel')&&(k={id:c.id,text:c.newLabel,map:a,css:c.hasOwnProperty('newLabelCSS')?c.newLabelCSS.toString():''},e.get({label:[c.id]},function(a){a.label.length?a.label.forEach(function(a){a.text=c.newLabel;g(a.span).addClass(c.newLabelCSS);a.bindTo('position',
c);a.draw()}):(h=new x(k),h.bindTo('position',c),e._labels.push(h));h.set('visible',c.showLabel);'object'===typeof h&&!0===b.markerCluster&&google.maps.event.addListener(c,'map_changed',function(){'function'===typeof h.setMap&&h.set('visible',null!==c.getMap())})}));e.bindEvents(c,c.event)},markerControl:function(){var a=this,b=a.options,c={css:'',label:'\u8acb\u9078\u64c7&hellip;',infoWindow:!0,panTo:!0,onChange:''},d;b.hasOwnProperty('markerControl')&&('string'===typeof b.markerControl?d=g(b.markerControl.toString()):
(d=b.markerControl.hasOwnProperty('container')?g(b.markerControl.container):g(b.markerControl),c=g.extend({},c,b.markerControl)),d.length&&a.get('marker',function(b){var f=['<select class="marker-list-control">','<option>'+c.label+'</option>'];b.forEach(function(a){'undefined'!==typeof a.infoWindow&&a.infoWindow.close();f.push('<option value="'+a.id+'">'+(a.title?a.title:a.id)+'</option>')});f.push('</select>');d.on('change.tinyMap','select',function(){var b=g(this);a.close('marker');this.value.length&&
a.get({marker:[this.value]},function(d){var e={};d.marker.length&&'undefined'!==d.marker[0]&&(e=d.marker[0],!0===c.infoWindow&&'undefined'!==typeof e.infoWindow&&'function'===typeof e.infoWindow.open&&e.infoWindow.open(a.map,e),!0===c.panTo&&a.map.panTo(e.getPosition()),'function'===typeof c.onChange&&c.onChange.call(b,e))})}).html(f.join(''));'string'===typeof c.css&&d.find('select').addClass(c.css)}))},placeMarkers:function(a,b,c){var d=this,e={},f={maxZoom:null,gridSize:60},h=Array.isArray(b.marker)?
b.marker:[];d.options.hasOwnProperty('markerCluster')&&'function'===typeof MarkerClusterer&&(f=g.extend({},f,b.markerCluster),d._clusters=new MarkerClusterer(a,[],f),f.hasOwnProperty('event')&&d.bindEvents(d._clusters,f.event));h.forEach(function(f){var h=q(f.addr,!0),n=d.markerIcon(f),m=!0,v=!1,t={},w={},B='undefined'!==typeof f.id?f.id:f.addr.toString().replace(/\s/g,''),l={id:B,map:a,animation:null,showLabel:!0},l=g.extend({},l,f);'modify'===c&&B&&d.get({marker:[B]},function(a){!Array.isArray(a.marker)||
!a.marker.length||f.hasOwnProperty('forceInsert')&&!0===f.forceInsert||(f=g.extend(a.marker[0],f),'function'===typeof d._clusters.removeMarker&&d._clusters.removeMarker(a.marker[0]),m=!1,v=!0)});f.hasOwnProperty('title')&&(l.title=f.title.toString().replace(/<([^>]+)>/g,''));g.isEmptyObject(n)||(l.icon=n);f.hasOwnProperty('animation')&&'string'===typeof f.animation&&(l.animation=google.maps.Animation[f.animation.toUpperCase()]);'string'===typeof h?(e=new google.maps.Geocoder,e.geocode({address:h},
function(e,h){h===google.maps.GeocoderStatus.OVER_QUERY_LIMIT?setTimeout(function(){d.placeMarkers(a,b,c)},d.interval):h===google.maps.GeocoderStatus.OK&&(!m&&v?('function'===typeof f.setPosition&&(f.setPosition(e[0].geometry.location),l.hasOwnProperty('title')&&f.setTitle(l.title),l.hasOwnProperty('icon')&&f.setIcon(l.icon)),w=f):(l.position=e[0].geometry.location,t=b.hasOwnProperty('markerWithLabel')&&!0===b.markerWithLabel?'function'===typeof MarkerWithLabel?new MarkerWithLabel(l):new google.maps.Marker(l):
new google.maps.Marker(l),d._markers.push(t),w=t),d.processMarker(a,b,w,c))})):(!m&&v?('function'===typeof f.setPosition&&(f.setPosition(h),l.hasOwnProperty('title')&&f.setTitle(l.title),l.hasOwnProperty('icon')&&f.setIcon(l.icon)),w=f):(l.position=h,t=b.hasOwnProperty('markerWithLabel')&&!0===b.markerWithLabel?'function'===typeof MarkerWithLabel?new MarkerWithLabel(l):new google.maps.Marker(l):new google.maps.Marker(l),d._markers.push(t),w=t),d.processMarker(a,b,w,c))});d.markerControl()},directionService:function(a,
b){var c=this,d=new google.maps.DirectionsService;Array.isArray(b.direction)&&b.direction.forEach(function(b){if('undefined'!==typeof b.from&&'undefined'!==typeof b.to){var f={},h=new google.maps.DirectionsRenderer,k=g.extend({},{infoWindow:new google.maps.InfoWindow,map:c.map},b),r=[],n=[],m=[];f.origin=q(b.from,!0);f.destination=q(b.to,!0);f.travelMode=b.hasOwnProperty('travel')&&google.maps.TravelMode[b.travel.toString().toUpperCase()]?google.maps.TravelMode[b.travel.toString().toUpperCase()]:
google.maps.TravelMode.DRIVING;b.hasOwnProperty('panel')&&g(b.panel).length&&(k.panel=g(b.panel).get(0));b.hasOwnProperty('requestExtra')&&b.requestExtra&&(f=g.extend({},f,b.requestExtra));b.hasOwnProperty('waypoint')&&Array.isArray(b.waypoint)&&(b.waypoint.forEach(function(a){var b={stopover:!0};'string'===typeof a||Array.isArray(a)?b.location=q(a,!0):a.hasOwnProperty('location')&&(b.location=q(a.location,!0),b.stopover=a.hasOwnProperty('stopover')?a.stopover:!0);n.push(a.text||a.toString());a.hasOwnProperty('icon')&&
m.push(a.icon.toString());r.push(b)}),f.waypoints=r);d.route(f,function(d,g){g===google.maps.DirectionsStatus.OK&&(d.routes.forEach(function(h,g){b.hasOwnProperty('renderAll')&&!0===b.renderAll&&!0===f.provideRouteAlternatives&&new google.maps.DirectionsRenderer({map:a,directions:d,routeIndex:g});var l=h.legs,r='',t='',q={},p=0;b.hasOwnProperty('fromText')&&(r=l[0].start_address=b.fromText);b.hasOwnProperty('toText')&&(1===l.length?l[0].end_address=b.toText:l[l.length-1].end_address=b.toText,t=b.toText);
b.hasOwnProperty('icon')&&(k.suppressMarkers=!0,b.icon.hasOwnProperty('from')&&'string'===typeof b.icon.from&&c.directionServiceMarker(l[0].start_location,{icon:b.icon.from,text:r},k.infoWindow,b),b.icon.hasOwnProperty('to')&&'string'===typeof b.icon.to&&c.directionServiceMarker(l[l.length-1].end_location,{icon:b.icon.to,text:t},k.infoWindow,b));for(p=1;p<l.length;p+=1)b.hasOwnProperty('icon')&&(b.icon.hasOwnProperty('waypoint')&&'string'===typeof b.icon.waypoint?q.icon=b.icon.waypoint:'string'===
typeof m[p-1]&&(q.icon=m[p-1]),q.text=n[p-1],c.directionServiceMarker(l[p].start_location,q,k.infoWindow,b))}),c.bindEvents(h,b.event),h.setOptions(k),h.setDirections(d),c._directions.push(h))})}})},directionServiceMarker:function(a,b,c,d){var e=this,f={},h=g.extend({},{position:a,map:e.map,id:d.hasOwnProperty('id')?d.id:''},b),k=new google.maps.Marker(h);h.hasOwnProperty('text')&&(f=function(){c.setPosition(a);c.setContent(h.text);c.open(e.map,k)});e._directionsMarkers.push(k);e.bindEvents(k,f)},
